...
import { GET_DOWNLOAD_REPORT, LIST_DOWNLOAD_LIVE_TEST_REPORT } from "../../apis/apis";
import CulsightPageLoader from "../../components/CulsightPageLoader";
import debounce from "lodash.debounce";
import { formatToIST } from "../../../helper/CommonHelper";

function LiveTestDownload() {
  ...
  const LIST_API = async (page = 1, perPage = page_size) => {
    ...
    const API_CALL = await LIST_DOWNLOAD_LIVE_TEST_REPORT(FORM_DATA);
...
export default LiveTestDownload;
