...
import { LIST_CITY, LIST_TOPIC, STATUS_TOPIC } from "../../../apis/apis";
...
function ListTopic() {
    ...
    const [add_topic, set_add_topic] = useState(false);
    const [edit_topic, set_edit_topic] = useState(null);
    ...
    const LIST_API = async () => {
        ...
        const API_CALL = await LIST_TOPIC(FORM_DATA);
    ...
    const change_status = async (id) => {
        ...
        try {
            const response = await STATUS_TOPIC(FORM_DATA);
                ...
                {!edit_topic && (
                    <Button
                        onClick={() => {
                            ...
                            set_add_topic(!add_topic);
                        }}
                    >
                        {add_topic ? "List View" : "Add Topic"}
                    </Button>
                )}
