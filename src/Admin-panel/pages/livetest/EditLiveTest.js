...
function EditLiveTest() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await EDIT_LIVE_TEST(FORM_DATA);
                ...
                {loading ? (
                    ...
                    <>
                        <h2> <span style={{ cursor: "pointer" }}
                            onClick={() => navigate("/live-test")}><LeftOutlined /></span> Edit Live Test Details</h2>
                        <Row>
                            <Col span={24}>
                                <Form
                                    layout="vertical"
