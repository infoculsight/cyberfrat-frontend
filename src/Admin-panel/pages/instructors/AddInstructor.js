...
import { ADD_INSTRUCTOR } from "../../apis/apis";
...
export default function AddInstructor() {
  ...
  const onFinish = async () => {
    ...
    try {
      const response = await ADD_INSTRUCTOR(FORM_DATA);
  ...
  return (
    <div className="lms-body">
      <Card>
        ...
        <Row>
          <Col span={12}>
            <h2><span style={{ cursor: "pointer" }} onClick={() => navigate("/instructors")} ><LeftOutlined /></span> Add Instructor</h2>
          </Col>
        </Row>
          ...
          {loading ? <>
            ...
            >
              ...
              <Form.Item label="Upload Your Photo here">
                ...
                </Upload>  {/* Error message under the uploader */}
                  {imageError && (
                    <span
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item name="address_line_1" label="Address 1">
                    <Input
                ...
                <Col span={12}>
                  <Form.Item name="address_line_2" label="Address 2">
                    <Input
