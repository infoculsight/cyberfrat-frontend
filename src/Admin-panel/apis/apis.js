...
export * from "./learner-api/LearnerApis";
...
export const LIST_APP_USERS = async (body) => {
    try {
        const response = await Axios.post('list-app-users/', body);
        return response;
    } catch (error) {
        console.error(error);
    }
...
export const APP_USER_STATUS = async (body) => {
    try {
        const response = await Axios.post('app-users-status/', body);
        return response;
    } catch (error) {
        console.error(error);
    }
...
export const APP_USER_ENROLL_IN_LMS = async (body) => {
    try {
        const response = await Axios.post('app-user-enroll-in-lms/', body);
        return response;
    } catch (error) {
        console.error(error);
    }
...
export const LIST_DOWNLOAD_USER_REPORT = async (body) => {
    try {
        const response = await Axios.post('list-download-users-report/', body);
        return response;
    } catch (error) {
        console.error(error);
    }
...
export const USER_REPORT = async (body) => {
    try {
        const response = await Axios.post('users-report/', body);
        return response;
    } catch (error) {
        console.error(error);
    }
...
export const LMS_SETTING = async (body) => { 
    try {
        const response = await Axios.post('lms-setting-view/', body);
        return response;
    } catch (error) {
        console.error(error);
    }  
...
export const LOGS_LIST = async (body) => { 
    try {
        const response = await Axios.post('logs-list/', body);
        return response;
    } catch (error) {
        console.error(error);
    }  
